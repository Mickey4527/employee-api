-- INSERT INTO employee(id, first_name,last_name,gender,department) VALUES (1, 'Tony','Stark');
-- INSERT INTO employee(id, first_name,last_name,gender,department) VALUES (2, 'Bruce' , 'Wayne');
